...
- `apply.sh` applies Breeze Dark and the fonts, then rebuilds both panels from `panels.js` through the Plasma scripting API. It backs up the applet config first and prints the undo command.
